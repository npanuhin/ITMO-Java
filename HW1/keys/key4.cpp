...
signed main() {
    ...
    // for (long long i = LLONG_MIN; i < (long long)(LLONG_MAX / 10 * 9); i += (long long)(LLONG_MAX / 10)) {
    //     // cout << i << endl;
    //     // res.insert(i >> 32);
    //     cout << i << ' ' << (i >> 32) << ' ' << (i ^ (i >> 32)) << endl;

    //     // if ((i ^ (i >> 32)) == 5740487520438743858LL) {
    //     //     cout << "Answer: " << i << endl;
    //     // }
    //  }
    ...
    long long a = 5740487520438743858LL;

    for (long long i = INT_MIN; i < INT_MAX; ++i) {
        long long b = a ^ i;
        if ((b >> 32) == i) {
            cout << "Answer: " << b << ' ' << (b >> 32) << ' ' << (b ^ (b >> 32)) << endl;
        }
    }
}
