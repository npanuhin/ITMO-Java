...
public abstract class AbstractCheckedBinaryOperator implements AbstractExpression {
    ...
    protected abstract BigDecimal count(BigDecimal left, BigDecimal right) throws OverflowException;
    ...
    public boolean equals(Object obj) {
        if (obj != null && this.getClass() == obj.getClass()) {
            return left.equals(((AbstractCheckedBinaryOperator) obj).left)
                && right.equals(((AbstractCheckedBinaryOperator) obj).right);
        }
        return false;
    }
